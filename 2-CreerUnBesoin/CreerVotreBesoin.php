			...
			<div class="form-row align-items-center">
				<div class="col-auto my-1">
				  <label class="mr-sm-2 sr-only" for="inlineFormCustomSelect">Preference</label>
					...
					<option selected>Choose une catégorie </option>
					<option value="1" title="...">Sport</option>
                                        <option value="2" title="Réunions créatives/Pitcher .....">Animation</option>
					<option value="3" title="...">Outils métiers</option>
                                        <option value="4" title="Yoga, méditation...">Développement personnel</option>
					<option value="5" title="...">Associatif</option>
                                        <option value="6" title="...">Covoiturage</option>
					<option value="7" title="Word, Excel, PowerPoint, Outlook...">Bureautique</option>
					<option value="8" title="Internet, site Web, réparation PC...">Informatique</option>
					<option value="9" title="Cuisine, bricolage, musique, théâtre, ciné, culture, philatélie, généalogie...">Loisir </option>
					<option value="10" title="Demande de créér une catégorie à l'administrateur">Autres </option>
				  </select>
				</div>
			</div>
			  ...
			  <div class="form-group">
				  <div class="form-check form-check-inline">
					  <input class="form-check-input" type="checkbox" name="pro" id="inlineCheckbox1" value="Pro">
					  <label class="form-check-label" for="inlineCheckbox1">Pro</label>
					</div>
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="checkbox" name="perso" id="inlineCheckbox2" value="Perso">
					  <label class="form-check-label" for="inlineCheckbox2">Perso</label>
					</div>
				  </div>
			  </div>
			  <div class="form-group">
