...
<!--------------------------------------------------------------------------------------------------------------------------------------------->
        <div class="jumbotron">
          <div class="container">
            ...
            <a href="BesoinC.php"><div class="alert alert-light" role="alert">
              Filtrer les besoins par catégorie
            </div></a>
		  
            <form method="GET" class="form-inline my-2 my-lg-0">
                        <input class="form-control mr-sm-2" type="search" name="mot" placeholder="Excel ..." aria-label="Search">
                        <button type="submit" class="btn btn-outline-dark" value="Valider">Recherche</button>
            </form> 
